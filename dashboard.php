...
<p style="color: #ffff">Quick view of the inventory!</p>
<div class="row">
<div class="col-sm-4" id="totalBrands">
<div class="card">
<div class="card-body">
<h5 class="card-title">Number of brands (on going)</h5>
<h2 class="card-text" style="text-align: left;">
<?php 
...
<h1 class="card-text" style="text-align: left;overflow: hidden;width: 97%;">
<?php 
...
<h2 class="card-text" style="text-align: left;"><?php echo $td; ?></h2>
</div>
</div>
</div>
</div>
